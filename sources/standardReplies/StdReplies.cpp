...
std::string RPL_NOTOPIC(const std::string& nickname, const std::string& channel) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << RPL_NOTOPIC_CODE << SPACE << nickname << SPACE
        << channel << " :No topic is set" << CRLF;
    return oss.str();
}
...
std::string RPL_TOPIC(const std::string& nickname, const std::string& channel,
    ...
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << RPL_TOPIC_CODE << SPACE << nickname << SPACE << channel
        << " :" << topic << CRLF;
    return oss.str();
}
...
std::string RPL_NAMREPLY(const std::string& nickname, const std::string& channel,
    ...
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << RPL_NAMREPLY_CODE << SPACE << nickname << " = "
...
std::string RPL_ENDOFNAMES(const std::string& nickname, const std::string& channel) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << RPL_ENDOFNAMES_CODE << SPACE << nickname << SPACE
...
std::string ERR_UNKNOWNCMD(const std::string& command) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_UNKNOWNCMD_CODE << " * " << command
...
std::string ERR_NONICKNAMEGIVEN(void) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_NONICKNAMEGIVEN_CODE << " * :No nickname given"
        << CRLF;
    return oss.str();
}
...
std::string ERR_ERRONEUSNICKNAME(const std::string& nickname) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_ERRONEUSNICKNAME_CODE << " * " << nickname
...
std::string ERR_NICKNAMEINUSE(const std::string& nickname) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_NICKNAMEINUSE_CODE << " * " << nickname
...
std::string ERR_USERONCHANNEL(const std::string& nickname, const std::string& channel) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_USERONCHANNEL_CODE << " * " << nickname << SPACE
...
std::string ERR_NEEDMOREPARAMS(const std::string& command) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_NEEDMOREPARAMS_CODE << " * " << command
...
std::string ERR_ALREADYREGISTRED(const std::string& nickname) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_ALREADYREGISTRED_CODE << " * " << nickname
...
std::string ERR_CHANNELISFULL(const std::string& channel) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_CHANNELISFULL_CODE << " * " << channel
...
std::string ERR_INVITEONLYCHAN(const std::string& channel) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_INVITEONLYCHAN_CODE << " * " << channel
...
std::string ERR_BADCHANNELKEY(const std::string& username, const std::string& channel) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_BADCHANNELKEY_CODE << " * " << username << SPACE
...
std::string RPL_PRIVMSG(const std::string& nickname, const std::string& other,
    ...
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << nickname << " PRIVMSG " << other << " :" << message
        << CRLF;
    return oss.str();
}
...
std::string ERR_NOTEXTTOSEND(const std::string& nickname) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_NOTEXTTOSEND_CODE << " * " << nickname
...
std::string ERR_NOSUCHCHANNEL(const std::string& channel) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_NOSUCHCHANNEL_CODE << " * " << channel
...
std::string ERR_NOTONCHANNEL(const std::string& channel) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_NOTONCHANNEL_CODE << " * " << channel
...
std::string ERR_NOSUCHNICK(const std::string& dest) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_NOSUCHNICK_CODE << " * " << dest << " :No such nick"
        << CRLF;
    return oss.str();
}
...
std::string ERR_CHANOPRISNEEDED(const std::string& nickname, const std::string& channel) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_CHANOPRISNEEDED_CODE << " * " << nickname << SPACE
...
std::string ERR_USERNOTINCHANNEL(const std::string& targetNick, const std::string& nickname,
    ...
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << ERR_USERNOTINCHANNEL_CODE << " * " << targetNick
        << SPACE << nickname << SPACE << channel << " :They aren't on that channel" << CRLF;
    return oss.str();
}
...
std::string RPL_INVITING(const std::string& targetNick, const std::string& nickname,
                         const std::string& channel) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << RPL_INVITING_CODE << " * " << nickname << SPACE
...
std::string RPL_INVITE(const std::string& targetNick, const std::string& nickname,
                       const std::string& channel) {
    std::ostringstream oss;
    oss << COLON << SERVER << SPACE << nickname << " INVITE " << targetNick << SPACE << channel
        << CRLF;
    return oss.str();
}
